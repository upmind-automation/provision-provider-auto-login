...
4. In your fork of upmind/provision-provider-auto-login copy the `src/Example` directory to create `src/FooPlatform` and update the namespace on files under `src/FooPlatform`
